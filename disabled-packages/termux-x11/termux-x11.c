...
# define TERMUX_PREFIX "/data/data/com.OxGames.Pluvia/files/usr"
#endif

#ifndef TERMUX_X11_DIR
# define TERMUX_X11_DIR "/data/data/com.OxGames.Pluvia.x11/"
#endif
...
int main(int argc, char *argv[]) {
	...
	char *server_argv[] = {TERMUX_PREFIX "/bin/am", "start", "-n", "com.OxGames.Pluvia.x11/.MainActivity", NULL};
